...
class RootService {
  ...
  /**
   *
   * @typedef ProcessHTMLResponseParameter
   * @property {object} payload The payload
   * @property {number} code The status code
   * @property {boolean} sendRawResponse defines response medium
   * @property {string} responseType A string defining the response type to return
   * @property {string} html A string consisting of html to render
   */

  /**
   *
   * This methods is used to format HTML responses and is called internally only
   * @method
   * @param {ProcessHTMLResponseParameter} destructuredObject The instance of the defined
   * param object
   * @returns {object} This always has error set to null and payload an object.
   */
  processHTMLResponse({
